...
module PDF
  module Errors
    ...
    #
    class InvalidTableSpan < Exception
      end
    ...
    # to their document
    #
    class IncompatibleStringEncoding < Exception
    end
    ...
    class UndefinedObjectName < Exception
    end
    ...
    # not exist
    class UnknownOutlineTitle < Exception
    end
