...
module PDF
  module Images
    ...
    class PNG < Image
      ...
      getter :palette, :img_data, :transparency
      getter :width, :height, :bits
      getter :color_type, :compression_method, :filter_method
      getter :interlace_method, :alpha_channel
      property :scaled_width, :scaled_height
